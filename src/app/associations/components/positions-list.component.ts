    ...
    <div class="d-flex flex-column">
      <div class="row justify-content-center">
        <div
          ...
          *ngFor="
            let position of filterPosition(asso.positions, 5, 100000)
              | orderBy: ['-role.hierarchy', 'role.name']
          "
        >
          <ng-container *ngIf="!position.loading">
            ...
            <div class="member-title p-1" [ngStyle]="asso | assoStyle">
              {{ position.role.name }}
            </div>
            <div class="member-name pt-1 pr-1 pl-1">
              {{ position.user.firstname + ' ' + position.user.lastname }}
            </div>
            <div class="member-name pb-1 pr-1 pl-1">
              {{ position.user.type + ' ' + position.user.promo }}
            </div>
          </ng-container>
      ...
      <div class="row justify-content-center">
        <div
          ...
          [ngStyle]="asso | assoStyle: 'accent'"
          *ngFor="
            let position of filterPosition(asso.positions, 3, 6)
              | orderBy: ['-role.hierarchy', 'role.name']
          "
        >
          <ng-container *ngIf="!position.loading">
      ...
      <div class="row justify-content-center">
        <div
          ...
          [ngStyle]="asso | assoStyle: 'accent'"
          *ngFor="
            let position of filterPosition(asso.positions, -100000, 4)
              | orderBy: ['-role.hierarchy', 'role.name']
          "
        >
          <ng-container *ngIf="!position.loading">
